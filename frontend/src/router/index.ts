...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: {
      requiresAuth: false,
      title: 'WeChat Payment OAuth Callback',
      titleKey: 'auth.wechatPayment.callbackTitle'
    }
  },
  {
...
const BACKEND_MODE_CALLBACK_PATHS = ['/auth/callback', '/auth/linuxdo/callback', '/auth/oidc/callback', '/auth/wechat/callback']
