export default {
  ...
  auth: {
    ...
    oidc: {
      signIn: "Continue with OIDC",
      signInNamed: "Continue with {provider}",
      orContinue: "or continue with email",
      callbackMissingToken: "Missing login token, please try again.",
    ...
    wechat: {
      ...
      callbackProcessing: "Completing WeChat sign-in, please wait...",
      callbackHint: "If you are not redirected automatically, please go back and try again.",
      callbackMissingToken: "Missing login token, please try again.",
      invitationRequired: "This WeChat account is not yet registered. The site requires an invitation code — please enter one to complete registration.",
      completeRegistration: "Complete Registration",
      completing: "Completing registration…",
      completeRegistrationFailed: "Registration failed. Please try again.",
    },
    ...
    oauthFlow: {
      ...
      chooseAccountActionHint: "You can bind an existing account or create a new one.",
      bindExistingAccount: "Bind Existing",
      createNewAccount: "Create Account",
      bindLoginHint: "Log in to your existing account and bind it to {providerName}.",
      createAccountHint: "Create a local account to finish the {providerName} sign-in setup.",
      logInAndBind: "Log In and Bind",
      useDifferentEmail: "Use Different Email",
      totpHint: "Enter the 6-digit code for {account} to finish binding {providerName}.",
      verifyAndContinue: "Verify and Continue",
      sendCodeAction: "Send Code",
      emailCodeSent: "Verification code sent successfully.",
      accountExistsSwitchToBind: "That email already exists. Please sign in to bind the existing account.",
      useProviderDisplayName: "Use the provider display name on my profile",
      orContinue: "or continue with email",
      wechatSystemBrowserOnly: "WeChat Open Platform login must be started in the system browser.",
      wechatBrowserOnly: "WeChat Official Account login must be started inside the WeChat browser.",
      wechatNativeAppOnly: "This site only has WeChat mobile app login configured. Please continue from the native app.",
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      description: "Configure low-balance alerts and extra notification emails",
      enabled: "Enable balance alerts",
      threshold: "Alert Threshold",
      thresholdPlaceholder: "Use system default threshold",
      thresholdHint: "Leave empty to use the global default",
      systemDefault: "System default",
      thresholdSaved: "Threshold updated",
      extraEmails: "Extra Notification Emails",
      maxEmails: "Up to 3 emails",
    ...
    authBindings: {
      title: "Sign-in Bindings",
      description: "Manage your real email and third-party sign-in methods",
      emailLabel: "Email",
      emailPlaceholder: "name@example.com",
      codePlaceholder: "6-digit code",
      passwordPlaceholder: "Set a local password",
      replaceEmailPasswordPlaceholder: "Enter current password to replace email",
      sendCodeAction: "Send Code",
      confirmEmailBindAction: "Bind Email",
      confirmEmailReplaceAction: "Replace Email",
      bindLinuxDoAction: "Bind Linux.do",
      bindOIDCAction: "Bind OIDC",
      bindWeChatAction: "Bind WeChat",
      unbindAction: "Unbind",
      linuxdoDescription: "Bind your Linux.do account for sign-in",
      oidcDescription: "Bind your OIDC account for sign-in",
      wechatDescription: "Bind your WeChat account for sign-in",
      status: {
        bound: "Bound",
        notBound: "Not Bound",
      },
  ...
  admin: {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        defaultModelHint:
          "Used by normal OpenAI-compatible paths when account-level mapping does not match",
        ...
        familyModelHint:
          "These family mappings apply only to `/v1/messages`; exact mappings override them",
        exactMappings: "Exact model mappings",
        addExactMapping: "Add mapping",
        exactMappingsHint:
          "Pin specific Claude models to exact OpenAI targets with higher priority than family defaults",
      ...
      accountFilter: {
        ...
        privacySetOnly:
          "Allow only accounts with privacy protection configured",
        privacySetOnlyEnabled:
          "Enabled: accounts without Privacy configured will be excluded",
        disabled: "Disabled",
      },
      modelRouting: {
        title: "Model Routing",
    ...
    channels: {
      ...
      createFirstChannel:
        "Create your first channel to manage model pricing and mappings.",
      groupsUnit: "groups",
      ...
      noGroupsSelected:
        "No group selected for {platform}. Select at least one group or disable this platform.",
      emptyModelsInPricing:
        "{platform} has pricing entries without models. Add models or remove those entries.",
      modelConflict:
        "{platform} has conflicting model patterns. Resolve the conflicts before saving.",
      mappingConflict:
        "{platform} has conflicting mapping source patterns. Resolve the conflicts before saving.",
      ...
      form: {
        ...
        models: "Models",
        modelsPlaceholder:
          "Type a model and press Enter. Wildcard * is supported",
        modelInputHint:
          "Press Enter to add. Paste is supported for batch import.",
        noModels: "No models added",
        billingMode: "Billing Mode",
        defaultPrices: "Default Prices (used when no interval matches)",
        defaultPerRequestPrice:
          "Default Per-Request Price (used when no tier matches)",
        ...
        intervals: "Context Interval Pricing (Optional)",
        addInterval: "Add Interval",
        requestTiers: "Per-Request Tiers",
        imageTiers: "Image Pricing Tiers",
        addTier: "Add Tier",
        ...
        perRequestPriceRequired:
          "Per-request/image billing requires a default price or at least one tier.",
  ...
  channelMonitor: {
    ...
    accounts: {
      ...
      types: {
        ...
        responsesApi: "OpenAI API / Compatible API",
      ...
      openai: {
        baseUrlHint:
          "Leave the default official OpenAI API endpoint unless you need a compatible upstream.",
      ...
      grok: {
        ...
        apiKeyHint:
          "Use an xAI Grok API key for official or compatible Grok upstreams.",
        apiKeyPlaceholder: "xai-...",
        baseUrlPresets: {
          official: "xAI Official",
        },
        importMode: "Import Mode",
        singleInputMode: "Single Input",
        batchImportMode: "Batch Import",
        ...
        batchNamePrefixHint:
          "Used only for batch import naming. Leave empty to let the backend use the default grok-sso prefix.",
        batchImportTitle: "Batch Import Grok SSO Token",
        batchImportHint:
          "One token or cookie per line. The backend owns parsing, normalization, validation, and dedupe.",
        batchImportPlaceholder:
          "sso=...\nsso=...\nsso=...; sso-rw=...; x-anonuserid=...",
        batchImportFormats:
          "Supported formats: raw sso value, sso=..., or a full Cookie header containing sso=...",
        batchImportDryRun: "Dry Run",
        batchImportDryRunHint:
          "Preview parsed results without creating any accounts.",
        batchImportTestAfterCreate: "Test After Create",
        batchImportTestAfterCreateHint:
          "Run the existing background connectivity and capability probe after account creation.",
        batchImportSettingsHint:
          "Notes, proxy, groups, concurrency, priority, rate multiplier, and load factor below will apply to every imported account.",
        ...
        batchImportSummaryCreated: "Created {count}",
        batchImportSummarySkipped: "Skipped {count}",
        batchImportSummaryInvalid: "Invalid {count}",
        batchImportDryRunBadge: "Dry Run",
        batchImportResultSuccess: "Ready",
        batchImportResultSkipped: "Not Imported",
        batchImportDryRunSummary:
          "Dry run complete. Ready: {created}, skipped: {skipped}, invalid: {invalid}.",
        batchImportSuccess:
          "Successfully imported {count} Grok session account(s).",
        batchImportPartial:
          "Batch import completed with partial results. Created: {created}, skipped: {skipped}, invalid: {invalid}.",
        batchImportFailedSummary:
          "Batch import did not create any accounts. Skipped: {skipped}, invalid: {invalid}.",
        runtime: {
          title: "Grok Runtime State",
          hint: "Read-only scheduler state synced from Grok auth, quota, capability, and probe signals.",
          tier: "Tier",
          source: "Source",
          ...
          quotaTitle: "Quota Windows",
          syncTitle: "Sync & Probe",
          models: "Models",
          resetAt: "Reset",
          ...
          empty: "No runtime snapshot yet",
          authModes: {
            session: "Session",
            apikey: "API Key",
            upstream: "Compatible Upstream"
          },
          tiers: {
            basic: "Basic",
            heavy: "Heavy",
      ...
      testPrompt: 'Default prompt: "hi"',
      customPromptLabel: "Test Prompt",
      customPromptPlaceholder:
        'Enter a custom prompt (leave empty for default "hi")',
      customPromptHint:
    ...
    proxies: {
      ...
      qualityStatusSkip: "Skip",
      qualityTargetBase: "Base Connectivity",
      qualityTargetIPType: "IP Type Check",
      qualityTargetAbuse: "Abuse Check",
      qualityTargetDNSLeak: "DNS Leak Check",
      qualityIPType: "IP Type",
      qualityIPTypeResidential: "Residential",
      qualityIPTypeDatacenter: "Datacenter",
      qualityIPTypeMobile: "Mobile",
      qualityIPTypeVPN: "VPN",
      qualityIPTypeTor: "Tor",
      qualityDNSLeak: "DNS Leak",
      qualityDNSLeakNone: "None",
      qualityDNSLeakPossible: "Possible",
      qualityDNSLeakDetected: "Detected",
      qualityCategoryTitle: "Category Scores",
      qualityCategoryReachability: "AI Reachability",
      qualityCategoryIPRisk: "IP Risk",
      qualityCategoryIPType: "IP Type",
      qualityCategoryAbuse: "Abuse History",
      qualityCategoryLatency: "Latency",
    ...
    ops: {
      ...
      errorDetail: {
        ...
        modelMapping: "Model Mapping",
        timings: "Timings",
        timingsHint: "Captured gateway stage durations",
        auth: "Auth",
        routing: "Routing",
        waitUser: "User Wait",
        waitAccount: "Account Wait",
        wsAcquire: "WS Acquire",
        wsHealthcheck: "WS Healthcheck",
        upstream: "Upstream",
        response: "Response",
        firstToken: "First Token",
      ...
      alertRules: {
        ...
        presets: {
          ...
          description:
            "Common starter rules built around unified scheduling-kernel risks, suitable as the first alerting baseline.",
          ...
          createPartial:
            "Created {success} recommended rule(s), while {failed} failed",
          createFailed: "Failed to create recommended rules",
          acquireSuccess: {
            name: "Low Acquire Success Rate",
            description:
              "Alert when unified scheduling-kernel acquire success stays below 75%.",
          },
          waitPlanSuccess: {
          ...
          pageDensity: {
            ...
            description:
              "Alert when indexed pages return too few candidates on average, indicating sparse pruning.",
          },
          idempotencyLatency: {
            name: "Slow Idempotency Path",
            description:
              "Alert when average idempotency processing time keeps rising, indicating contention or store pressure.",
          },
        },
        emptyState: {
          title: "No alerting baseline yet",
          description:
            "Start with the unified scheduling-kernel presets so acquire, wait-plan payoff, index density, and idempotency latency are covered before you add finer-grained business rules.",
        },
        dashboardBaseline: {
          title: "Alerting baseline is not initialized",
          description:
            "The Ops dashboard currently has no alert rules. Start with the unified scheduling-kernel presets so acquire, wait-plan payoff, index density, and idempotency latency are covered by default.",
        ...
        metricDescriptions: {
          ...
          schedulerAcquireSuccessRate:
            "Acquire success rate inside the unified scheduling kernel runtime path (0-100).",
          schedulerWaitPlanSuccessRate:
            "Final success rate after entering the unified scheduling wait-plan path (0-100).",
          schedulerIndexPageDensity:
            "Average accounts fetched per indexed page, indicating how concentrated candidate pruning is.",
          idempotencyProcessingAvgMs:
            "Average processing time per recorded idempotency operation (milliseconds).",
      ...
      runtimeObservability: {
        ...
        pageDensityHint:
          "Average accounts fetched per indexed page. Higher usually means pruning is keeping page fetches concentrated.",
        pageDensityRisk: "Index pruning is sparse",
        pageDensityRiskHint:
          "Page fetches are too sparse, which suggests candidate pruning is not concentrated enough and the hot path may be over-paging.",
        acquireSuccess: "Acquire Success",
        acquireSuccessHint:
          "Runtime acquire success rate. Low values usually mean the hot path is probing too many full or unusable accounts.",
        acquireRisk: "Acquire hit rate is low",
        acquireRiskHint:
          "The hot path is probing too many full, unusable, or ultimately missed candidates. Check pruning quality and account saturation first.",
        waitPlanSuccess: "Wait-plan Success",
        waitPlanSuccessHint:
          "Success ratio after entering the wait plan. Low values suggest queue waits are paying off poorly or ending in misses.",
        waitPlanRisk: "Wait-plan payoff is low",
        waitPlanRiskHint:
          "Wait-plan attempts are still ending in frequent misses, which suggests queueing is not buying enough success and supply may be too thin.",
        idempotencyAvg: "Idempotency Avg",
        idempotencyAvgHint:
          "Average processing time per recorded idempotency operation. Sustained growth points to store contention or locking overhead.",
        idempotencyRisk: "Idempotency path is slow",
        idempotencyRiskHint:
          "Average idempotency processing time is rising, which may indicate store contention, lock waits, or replay hotspots.",
        runtimeProbes: "Runtime Probes",
        notTriggered: "Not triggered",
        healthyTitle: "Scheduling kernel is stable",
        healthyHint:
          "Index pruning, acquire, and wait-plan signals look healthy right now, with no obvious hot-path degradation.",
      },
      queryMode: {
        auto: "Auto",
        raw: "Raw",
    ...
    settings: {
      ...
      registration: {
        ...
        forceEmailOnThirdPartySignup: "Force Email For Third-Party Signup",
        forceEmailOnThirdPartySignupHint:
          "Third-party OAuth sign-ins must confirm or bind an email before creating an account",
      ...
      oidc: {
        title: "OIDC Login",
        description: "Configure generic OIDC OAuth for end-user login",
        enable: "Enable OIDC Login",
        enableHint: "Show OIDC login on the login/register pages",
        providerName: "Provider Name",
        providerNamePlaceholder: "OIDC",
        providerNameHint: "Friendly provider label shown to users",
        clientId: "Client ID",
        clientIdPlaceholder: "client-id",
        clientSecret: "Client Secret",
        clientSecretPlaceholder: "********",
        clientSecretHint: "Server-side secret used for token exchange",
        clientSecretConfiguredPlaceholder: "********",
        clientSecretConfiguredHint: "Secret configured. Leave empty to keep the current value.",
        authorizeUrl: "Authorize URL",
        authorizeUrlPlaceholder: "https://id.example.com/oauth2/authorize",
        tokenUrl: "Token URL",
        tokenUrlPlaceholder: "https://id.example.com/oauth2/token",
        userInfoUrl: "UserInfo URL",
        userInfoUrlPlaceholder: "https://id.example.com/oauth2/userinfo",
        jwksUrl: "JWKS URL",
        jwksUrlPlaceholder: "https://id.example.com/.well-known/jwks.json",
        issuerUrl: "Issuer URL",
        issuerUrlPlaceholder: "https://id.example.com/realms/main",
        discoveryUrl: "Discovery URL",
        discoveryUrlPlaceholder: "https://id.example.com/.well-known/openid-configuration",
        scopes: "Scopes",
        ...
        frontendRedirectUrl: "Frontend Redirect",
        ...
        usePkce: "Use PKCE",
        usePkceHint: "Recommended for public clients and token_auth_method=none",
        validateIdToken: "Validate ID Token",
        validateIdTokenHint: "Verify id_token signature and nonce using JWKS",
        requireEmailVerified: "Require Verified Email",
        requireEmailVerifiedHint: "Reject sign-in when upstream email is not verified",
        quickSetCopy: "Generate & Copy (current site)",
        redirectUrlSetAndCopied: "Redirect URL generated and copied to clipboard"
      },
      notify: {
        title: "Notification Settings",
        description: "Configure low-balance and account quota email notifications.",
        balanceEnabled: "Enable low-balance notifications",
        balanceEnabledHint: "Allow users to receive balance alerts.",
        quotaEnabled: "Enable account quota notifications",
        quotaEnabledHint: "Send account quota alerts to admin recipients.",
        balanceThreshold: "Default balance threshold",
      ...
      defaults: {
        ...
        authSourceDefaultsTitle: "Auth Source Default Grants",
        authSourceDefaultsDescription: "Configure different balance, concurrency and subscription grants for each signup or first-bind source.",
        authSourceSubscriptionsHint: "These subscriptions are assigned only when the corresponding source grant switch is enabled.",
        grantOnSignup: "Grant On Signup",
        grantOnSignupHint: "Apply these defaults when a new account is created from this source.",
        grantOnFirstBind: "Grant On First Bind",
        grantOnFirstBindHint: "Apply these defaults the first time this source is bound to an existing account.",
        authSourceEmailTitle: "Email Signup",
        authSourceEmailDescription: "Defaults for direct email registration and email completion flows.",
        authSourceLinuxDoTitle: "LinuxDo OAuth",
        authSourceLinuxDoDescription: "Defaults for LinuxDo sign-in and first-time binding.",
        authSourceOidcTitle: "OIDC OAuth",
        authSourceOidcDescription: "Defaults for generic OIDC sign-in and first-time binding.",
        authSourceWeChatTitle: "WeChat OAuth",
        authSourceWeChatDescription: "Defaults for WeChat sign-in and first-time binding.",
      },
      claudeCode: {
      ...
      modelRouting: {
        ...
        fallbackGemini: "Gemini Fallback Model",
        fallbackGeminiHint:
          "Used when Gemini routing falls back to a default model.",
        fallbackAntigravity: "Antigravity Fallback Model",
        fallbackAntigravityHint:
          "Used when Antigravity routing falls back to a default model.",
        grokOfficialBaseUrl: "Grok Official API Base URL",
        grokOfficialBaseUrlHint:
          "Default upstream base URL for Grok apikey/upstream accounts when the account does not override it.",
        ...
        grokQuotaSyncIntervalSeconds: "Grok Quota Sync Interval (seconds)",
        grokQuotaSyncIntervalSecondsHint:
          "How often Grok quota and tier snapshots are resynced into scheduler state.",
        grokUsageSyncConcurrency: "Grok Quota Sync Concurrency",
        grokUsageSyncConcurrencyHint:
          "How many Grok session accounts can be refreshed in parallel during quota sync.",
        grokCapabilityProbeIntervalSeconds:
          "Grok Capability Probe Interval (seconds)",
        grokCapabilityProbeIntervalSecondsHint:
          "How often unknown-tier compatible Grok accounts are reprobed for capability signals.",
        grokCapabilityProbeConcurrency: "Grok Capability Probe Concurrency",
        grokCapabilityProbeConcurrencyHint:
          "How many Grok accounts can be probed in parallel for capability signals.",
        grokSessionValidityCheckInterval:
          "Grok Session Validity Check Interval (seconds)",
        grokSessionValidityCheckIntervalHint:
          "How often Grok Web session accounts are revalidated for validity, tier, and capability state.",
        grokVideoTimeout: "Grok Video Request Timeout (seconds)",
      ...
      gatewayForwarding: {
        ...
        cchSigningHint:
          "Replace the billing header cch placeholder with a deterministic hash after request mutations.",
      },
      site: {
        title: "Site Settings",
      ...
      betaPolicy: {
        ...
        modelWhitelist: "Model Whitelist",
        modelWhitelistHint:
          "One pattern per line. Leave empty to apply the rule to all models. Supports exact match and wildcard prefix like claude-opus-*.",
        modelPatternPlaceholder: "claude-opus-*\nclaude-opus-4-1",
  ...
  payment: {
    ...
    rechargeRatePreview: "At the current rule, recharge credit multiplier is {usd}",
    ...
    admin: {
      ...
      insufficientBalance: "Insufficient balance, balance will be deducted to $0",
