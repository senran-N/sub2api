export default {
  ...
  admin: {
    ...
    channels: {
      ...
      createFirstChannel: 'Create your first channel to manage model pricing and mappings.',
      groupsUnit: 'groups',
      ...
      modelConflict: '{platform} has conflicting model patterns. Resolve the conflicts before saving.',
      mappingConflict: '{platform} has conflicting mapping source patterns. Resolve the conflicts before saving.',
      ...
      form: {
        ...
        models: 'Models',
        modelsPlaceholder: 'Type a model and press Enter. Wildcard * is supported',
        modelInputHint: 'Press Enter to add. Paste is supported for batch import.',
        ...
        perRequestPriceRequired: 'Per-request/image billing requires a default price or at least one tier.',
    ...
    accounts: {
      ...
      customPromptPlaceholder: 'Enter a custom prompt (leave empty for default "hi")',
      customPromptHint: 'Optional. Customize the prompt sent to the upstream API for testing.',
