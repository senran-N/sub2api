export default {
  ...
  auth: {
    ...
    wechat: {
      ...
      callbackProcessing: "正在处理微信登录，请稍候...",
      callbackHint: "如果页面未自动跳转，请返回重试。",
      callbackMissingToken: "登录信息缺失，请返回重试。",
      invitationRequired: "该微信账号尚未注册，站点已开启邀请码注册，请输入邀请码以完成注册。",
      completeRegistration: "完成注册",
      completing: "正在完成注册...",
      completeRegistrationFailed: "注册失败，请重试。",
    },
    ...
    oauthFlow: {
      ...
      chooseAccountActionHint: "您可以绑定现有账号，或创建一个新账号继续。",
      bindExistingAccount: "绑定现有账号",
      createNewAccount: "创建新账号",
      bindLoginHint: "登录您的现有账号，并将其绑定到 {providerName}。",
      createAccountHint: "创建本地账号以完成 {providerName} 登录设置。",
      logInAndBind: "登录并绑定",
      useDifferentEmail: "改用其他邮箱",
      totpHint: "请输入 {account} 的 6 位验证码，以完成 {providerName} 绑定。",
      verifyAndContinue: "验证并继续",
      sendCodeAction: "发送验证码",
      emailCodeSent: "验证码发送成功。",
      accountExistsSwitchToBind: "该邮箱已存在，请登录后绑定到现有账号。",
      useProviderDisplayName: "使用第三方昵称更新我的资料",
      orContinue: "或使用邮箱密码继续",
      wechatSystemBrowserOnly: "微信开放平台登录需要在系统浏览器中发起。",
      wechatBrowserOnly: "微信公众号登录只能在微信内置浏览器中发起。",
      wechatNativeAppOnly: "当前仅配置了微信移动应用登录，请在原生 App 中继续。",
      wechatNotConfigured: "微信登录尚未配置。"
    },
    oauth: {
      callbackTitle: "OAuth 回调",
      callbackDescription:
        "将 code，以及需要时的 state，复制回管理后台授权流程中。",
      code: "授权码",
      state: "状态",
      fullUrl: "完整URL",
    },
  ...
  profile: {
    ...
    balanceNotify: {
      title: "余额提醒",
      description: "配置余额不足提醒和额外通知邮箱",
      enabled: "启用余额提醒",
      threshold: "提醒阈值",
      thresholdPlaceholder: "使用系统默认阈值",
      thresholdHint: "留空则使用全局默认值",
      systemDefault: "系统默认",
    ...
    authBindings: {
      title: "登录绑定",
      description: "管理真实邮箱与第三方登录方式",
      emailLabel: "邮箱",
      emailPlaceholder: "name@example.com",
      codePlaceholder: "6 位验证码",
      passwordPlaceholder: "设置本地登录密码",
      replaceEmailPasswordPlaceholder: "输入当前密码以更换邮箱",
      sendCodeAction: "发送验证码",
      confirmEmailBindAction: "绑定邮箱",
      confirmEmailReplaceAction: "更换邮箱",
      bindLinuxDoAction: "绑定 Linux.do",
      bindOIDCAction: "绑定 OIDC",
      bindWeChatAction: "绑定微信",
      unbindAction: "解绑",
      linuxdoDescription: "绑定 Linux.do 账号作为登录方式",
      oidcDescription: "绑定 OIDC 账号作为登录方式",
      wechatDescription: "绑定微信账号作为登录方式",
      status: {
        bound: "已绑定",
        notBound: "未绑定",
      },
  ...
  admin: {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        defaultModelHint:
          "普通 OpenAI 兼容路径未命中账号级模型映射时使用此模型",
        opusModel: "Opus 默认映射",
        ...
        familyModelHint:
          "仅 `/v1/messages` 使用这些分族映射；未写精确映射时按 Opus/Sonnet/Haiku 回退",
        exactMappings: "精确模型映射",
        addExactMapping: "添加映射",
        exactMappingsHint:
          "可为具体 Claude 模型单独指定目标 OpenAI 模型，优先级高于分族映射",
    ...
    channels: {
      ...
      noChannelsYet: "暂无渠道",
      createFirstChannel: "创建第一个渠道来管理模型定价与映射。",
      groupsUnit: "个分组",
      pricingUnit: "条规则",
      statusActive: "启用",
      statusDisabled: "停用",
      ...
      noGroupsSelected:
        "{platform} 平台未选择分组，请至少选择一个分组或禁用该平台",
      emptyModelsInPricing:
        "{platform} 平台下有定价条目未添加模型，请添加模型或删除该条目",
      modelConflict: "{platform} 平台下存在冲突的模型模式，请调整后再保存",
      mappingConflict: "{platform} 平台下存在冲突的映射源模型，请调整后再保存",
      ...
      form: {
        ...
        restrictModels: "限制模型",
        restrictModelsHint:
          "启用后，仅允许定价列表中的模型，其余模型将被拒绝。",
        billingModelSource: "计费依据",
        billingModelSourceHint: "控制计费时使用哪个模型名进行价格匹配",
        billingModelSourceChannelMapped: "按渠道映射后的模型计费",
        billingModelSourceRequested: "按用户请求模型计费",
        ...
        modelMapping: "模型映射",
        noMappingRules: "暂无映射规则，点击“添加”创建一条。",
        mappingSource: "源模型",
        mappingTarget: "目标模型",
        modelPricing: "模型定价",
        noPricingRules: "暂无定价规则，点击“添加”创建一条。",
        pricingEntry: "定价配置",
        models: "模型列表",
  ...
  channelMonitor: {
    ...
    accounts: {
      ...
      grok: {
        ...
        importMode: "导入模式",
        singleInputMode: "单个输入",
        batchImportMode: "批量导入",
        ...
        batchNamePrefixHint:
          "仅用于批量导入命名。留空时后端会自动使用默认前缀 grok-sso。",
        batchImportTitle: "批量导入 Grok SSO Token",
        batchImportHint:
          "每行一个 token 或 Cookie。解析、归一化、校验和去重都以后端结果为准。",
        batchImportPlaceholder:
          "sso=...\nsso=...\nsso=...; sso-rw=...; x-anonuserid=...",
        batchImportFormats:
          "支持三种格式：纯 sso 值、sso=...、或包含 sso=... 的完整 Cookie 串。",
        batchImportDryRun: "仅预览",
        batchImportDryRunHint: "只预览解析结果，不实际创建账号。",
        batchImportTestAfterCreate: "创建后测试",
        batchImportTestAfterCreateHint:
          "创建完成后异步触发现有连通性测试和能力探测。",
        batchImportSettingsHint:
          "下方的备注、代理、分组、并发、优先级、倍率和负载因子会应用到所有导入账号。",
        ...
        batchImportSummaryCreated: "创建 {count}",
        batchImportSummarySkipped: "跳过 {count}",
        batchImportSummaryInvalid: "无效 {count}",
        batchImportDryRunBadge: "仅预览",
        batchImportResultSuccess: "通过",
        batchImportResultSkipped: "未导入",
        batchImportDryRunSummary:
          "预览完成。可创建 {created}，跳过 {skipped}，无效 {invalid}。",
        batchImportSuccess: "成功导入 {count} 个 Grok Session 账号。",
        batchImportPartial:
          "批量导入已完成。创建 {created}，跳过 {skipped}，无效 {invalid}。",
        batchImportFailedSummary:
          "批量导入未创建任何账号。跳过 {skipped}，无效 {invalid}。",
        runtime: {
          title: "Grok 运行时状态",
          hint: "只读展示当前 Grok 账号的认证模式、quota、能力和探测快照。",
          tier: "层级",
          source: "来源",
          confidence: "置信度",
          authMode: "认证模式",
      ...
      gemini: {
        ...
        oauthType: {
          ...
          codeAssistDesc: "企业级 OAuth，需要 GCP 项目。",
          codeAssistRequirement:
            "需要激活 GCP 项目并绑定信用卡后使用 Code Assist。",
    ...
    proxies: {
      ...
      qualityStatusSkip: "跳过",
      qualityTargetBase: "基础连通性",
      qualityTargetIPType: "IP 类型检查",
      qualityTargetAbuse: "滥用历史检查",
      qualityTargetDNSLeak: "DNS 泄漏检查",
      qualityIPType: "IP 类型",
      qualityIPTypeResidential: "家庭宽带",
      qualityIPTypeDatacenter: "数据中心",
      qualityIPTypeMobile: "移动网络",
      qualityIPTypeVPN: "VPN",
      qualityIPTypeTor: "Tor",
      qualityDNSLeak: "DNS 泄漏",
      qualityDNSLeakNone: "无",
      qualityDNSLeakPossible: "可能",
      qualityDNSLeakDetected: "已检测到",
      qualityCategoryTitle: "维度评分",
      qualityCategoryReachability: "AI 可达性",
      qualityCategoryIPRisk: "IP 风险",
      qualityCategoryIPType: "IP 类型",
      qualityCategoryAbuse: "滥用历史",
      qualityCategoryLatency: "延迟",
    ...
    ops: {
      ...
      errorDetail: {
        ...
        modelMapping: "模型映射",
        timings: "时序信息",
        timingsHint: "展示网关记录的阶段耗时",
        auth: "认证",
        routing: "路由",
        waitUser: "用户等待",
        waitAccount: "账号等待",
        wsAcquire: "WS 建连获取",
        wsHealthcheck: "WS 健康检查",
        upstream: "上游",
        response: "响应",
        firstToken: "首 Token",
        classification: "错误分类",
      ...
      alertRules: {
        ...
        presets: {
          title: "推荐模板",
          description:
            "基于统一调度内核的常见风险预设，适合直接作为第一版告警规则。",
          createAll: "创建推荐规则",
          created: "已创建",
          allCreated: "推荐规则已全部存在",
          createSuccess: "已创建 {count} 条推荐规则",
          createPartial:
            "已创建 {success} 条推荐规则，另有 {failed} 条创建失败",
          ...
          pageDensity: {
            name: "索引页密度过低",
            description:
              "当索引分页平均每页命中账号过少时告警，帮助发现候选裁剪过散。",
          },
          idempotencyLatency: {
            name: "幂等处理变慢",
            description:
              "当幂等平均处理耗时持续升高时告警，帮助发现锁竞争或存储瓶颈。",
          },
        },
        emptyState: {
          title: "还没有告警基线",
          description:
            "先落一版统一调度内核的推荐规则，先把 Acquire、Wait-plan、索引密度和幂等耗时纳入默认监控，再按你的业务补充更细粒度规则。",
        },
        dashboardBaseline: {
          title: "告警基线尚未初始化",
          description:
            "当前 Ops 看板还没有任何告警规则。建议先落统一调度内核的推荐规则，把 Acquire、Wait-plan、索引密度与幂等耗时纳入默认运营监控。",
          action: "初始化告警基线",
        },
        metrics: {
          successRate: "成功率 (%)",
        ...
        metricDescriptions: {
          ...
          schedulerAcquireSuccessRate:
            "统一调度内核在运行时 Acquire 阶段的成功率（0~100）。",
          schedulerWaitPlanSuccessRate:
            "统一调度内核进入 Wait-plan 后最终成功的比例（0~100）。",
          schedulerIndexPageDensity:
            "索引分页每页平均拉回的账号数量，反映候选裁剪是否足够集中。",
          idempotencyProcessingAvgMs:
            "幂等处理中每次已记录处理的平均耗时（毫秒）。",
      ...
      runtimeObservability: {
        ...
        pageDensity: "页密度",
        pageDensityHint:
          "索引分页每页平均拉回的账号数量。越高说明索引裁剪后每次页抓取更集中。",
        pageDensityRisk: "索引裁剪偏散",
        pageDensityRiskHint:
          "分页抓取过于稀疏，说明候选索引过滤不够集中，热路径可能在做无效翻页。",
        acquireSuccess: "Acquire 成功",
        acquireSuccessHint:
          "运行时 Acquire 成功率。偏低通常意味着热路径命中过多不可用/已满账号。",
        acquireRisk: "Acquire 命中偏低",
        acquireRiskHint:
          "热路径正在探测过多不可用、已满或最终落空的候选账号，建议先看索引裁剪与账号饱和度。",
        waitPlanSuccess: "Wait-plan 成功",
        waitPlanSuccessHint:
          "进入等待计划后的成功比例。偏低说明队列等待收益不足或最终落空较多。",
        waitPlanRisk: "Wait-plan 收益偏低",
        waitPlanRiskHint:
          "等待计划触发后仍然频繁失败，说明排队带来的收益有限，需检查队列策略或账号供给。",
        idempotencyAvg: "幂等均耗时",
        idempotencyAvgHint:
          "幂等处理中每次已记录处理的平均耗时。持续上升时应关注幂等存储与锁竞争。",
        idempotencyRisk: "幂等路径变慢",
        idempotencyRiskHint:
          "幂等平均处理耗时升高，可能存在存储竞争、锁等待或回放热点。",
        runtimeProbes: "运行时探测",
        notTriggered: "未触发",
        healthyTitle: "调度内核运行平稳",
        healthyHint:
          "当前索引裁剪、Acquire 与 Wait-plan 的整体信号正常，未发现明显热点退化。",
      },
      queryMode: {
        auto: "Auto（自动）",
        raw: "Raw（不聚合）",
    ...
    settings: {
      ...
      registration: {
        ...
        forceEmailOnThirdPartySignup: "第三方注册强制邮箱确认",
        forceEmailOnThirdPartySignupHint:
          "开启后，第三方 OAuth 登录在创建账号前必须先确认或绑定邮箱",
      ...
      wechatConnect: {
        title: "微信登录",
        description: "配置微信 OAuth，用于终端用户登录。",
        enable: "启用微信登录",
        enableHint: "在登录/注册页面显示微信登录入口",
        openEnabled: "启用开放平台",
        openEnabledHint: "桌面浏览器扫码登录。",
        mpEnabled: "启用公众号",
        mpEnabledHint: "在微信内置浏览器中授权登录。",
        mobileEnabled: "启用移动应用",
        mobileEnabledHint: "预留原生 App SDK 登录。",
        mode: "默认模式",
        modeOpen: "开放平台",
        modeMp: "公众号",
        modeMobile: "移动应用",
        ...
        openAppId: "开放平台 App ID",
        openAppSecret: "开放平台 App Secret",
        openAppSecretPlaceholder: "********",
        mpAppId: "公众号 App ID",
        mpAppSecret: "公众号 App Secret",
        mpAppSecretPlaceholder: "********",
        mobileAppId: "移动应用 App ID",
        mobileAppSecret: "移动应用 App Secret",
        mobileAppSecretPlaceholder: "********",
        ...
        quickSetCopy: "使用当前站点生成并复制",
        redirectUrlSetAndCopied: "已生成回调地址并复制到剪贴板"
      },
      oidc: {
        title: "OIDC 登录",
        description: "配置通用 OIDC OAuth，用于终端用户登录",
        enable: "启用 OIDC 登录",
        enableHint: "在登录/注册页面显示 OIDC 登录入口",
        providerName: "Provider Name",
        providerNamePlaceholder: "OIDC",
        providerNameHint: "向用户展示的登录提供方名称",
        clientId: "Client ID",
      ...
      notify: {
        title: "通知设置",
        description: "配置余额不足和账号配额邮件提醒。",
        balanceEnabled: "启用余额不足提醒",
        balanceEnabledHint: "允许用户收到余额不足告警。",
        quotaEnabled: "启用账号配额提醒",
        quotaEnabledHint: "向管理员收件人发送账号配额告警。",
        balanceThreshold: "默认余额阈值",
        rechargeUrl: "充值链接",
        quotaEmails: "配额告警收件人",
      ...
      defaults: {
        ...
        authSourceDefaultsTitle: "按登录来源发放默认权益",
        authSourceDefaultsDescription: "为不同注册/首次绑定来源分别配置余额、并发和订阅发放规则。",
        authSourceSubscriptionsHint: "仅当对应来源的发放开关开启时，才会分配这些订阅。",
        grantOnSignup: "注册时发放",
        grantOnSignupHint: "当用户通过该来源新建账号时应用这些默认值。",
        grantOnFirstBind: "首次绑定时发放",
        grantOnFirstBindHint: "当该来源首次绑定到已有账号时应用这些默认值。",
        authSourceEmailTitle: "邮箱注册",
        authSourceEmailDescription: "用于直接邮箱注册及邮箱补全创建账号流程。",
        authSourceLinuxDoTitle: "LinuxDo OAuth",
        authSourceLinuxDoDescription: "用于 LinuxDo 登录和首次绑定。",
        authSourceOidcTitle: "OIDC OAuth",
        authSourceOidcDescription: "用于通用 OIDC 登录和首次绑定。",
        authSourceWeChatTitle: "微信 OAuth",
        authSourceWeChatDescription: "用于微信登录和首次绑定。",
      },
      claudeCode: {
      ...
      modelRouting: {
        title: "模型路由",
        description: "配置 fallback 模型，以及 Grok 自有的媒体与运行时控制面设置。",
        enableFallback: "启用模型回退",
        enableFallbackHint: "当请求模型无法完成选路时，才使用已配置的回退模型重新选路。",
        fallbackAnthropic: "Anthropic 回退模型",
        fallbackAnthropicHint: "Anthropic 模型路由显式回退时使用的模型。",
        fallbackOpenai: "OpenAI 回退模型",
        fallbackOpenaiHint: "OpenAI 模型路由显式回退时使用的模型。",
        fallbackGrok: "Grok 回退模型",
        fallbackGrokHint: "Grok 请求发生模型回退时使用的默认模型。",
        fallbackGemini: "Gemini 回退模型",
        fallbackGeminiHint: "Gemini 请求发生模型回退时使用的默认模型。",
        fallbackAntigravity: "Antigravity 回退模型",
        fallbackAntigravityHint:
          "Antigravity 请求发生模型回退时使用的默认模型。",
        grokOfficialBaseUrl: "Grok 官方 API Base URL",
        grokOfficialBaseUrlHint:
          "用于 Grok apikey/upstream 账号未单独填写 base URL 时的默认上游地址。",
        ...
        grokQuotaSyncIntervalSecondsHint:
          "控制把 Grok 配额与 tier 快照回写到调度状态的周期。",
        grokUsageSyncConcurrency: "Grok 配额同步并发数",
        grokUsageSyncConcurrencyHint:
          "控制 Grok 配额同步 worker 并发抓取 session quota 的账号数。",
        grokCapabilityProbeIntervalSeconds: "Grok 能力探测间隔（秒）",
        grokCapabilityProbeIntervalSecondsHint:
          "控制 unknown-tier 的兼容型 Grok 账号重新探测能力信号的周期。",
        grokCapabilityProbeConcurrency: "Grok 能力探测并发数",
        grokCapabilityProbeConcurrencyHint:
          "控制 Grok 能力探测 worker 并发检查账号可用性的数量。",
        grokSessionValidityCheckInterval: "Grok Session 有效性检查间隔（秒）",
        grokSessionValidityCheckIntervalHint:
          "控制 Grok Web session 账号的有效性、等级和能力刷新周期。",
        grokVideoTimeout: "Grok 视频请求超时（秒）",
      ...
      gatewayForwarding: {
        ...
        cchSigning: "CCH 签名",
        cchSigningHint:
          "在请求改写完成后，将 billing header 的 cch 占位符替换为确定性哈希值。",
      },
      site: {
        title: "站点设置",
        description: "自定义站点品牌",
      ...
      betaPolicy: {
        ...
        modelWhitelist: "模型白名单",
        modelWhitelistHint:
          "每行一个模式。留空则规则对所有模型生效。支持精确匹配和前缀通配符，如 claude-opus-*。",
        modelPatternPlaceholder: "claude-opus-*\nclaude-opus-4-1",
        fallbackAction: "未命中白名单时的处理方式",
        fallbackErrorMessagePlaceholder:
          "未命中白名单模型被拦截时返回的自定义错误消息",
      },
      saveSettings: "保存设置",
      saving: "保存中...",
  ...
  payment: {
    ...
    rechargeRatePreview: "按当前规则，充值到账倍率为 {usd}",
    refundReason: "退款原因",
