...
export function getSeverityClass(severity: OpsSeverity): string {
  const classes: Record<string, string> = {
    P0: 'theme-chip theme-chip--compact theme-chip--danger',
    P1: 'theme-chip theme-chip--compact theme-chip--brand-orange',
    P2: 'theme-chip theme-chip--compact theme-chip--warning',
    P3: 'theme-chip theme-chip--compact theme-chip--info'
  }
