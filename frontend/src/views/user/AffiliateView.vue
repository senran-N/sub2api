      ...
      <template v-else-if="detail">
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="card p-5">
            <p class="text-sm text-gray-500 dark:text-dark-400">
              {{ t('affiliate.stats.invitedUsers') }}
            </p>
        ...
        <div class="card p-6">
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div
                class="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900"
              >
                <code class="flex-1 truncate text-sm font-semibold text-gray-900 dark:text-white">
                  {{ detail.aff_code }}
                </code>
            ...
            <div class="space-y-2">
              ...
              <div
                class="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900"
              >
                <code class="flex-1 truncate text-sm text-gray-700 dark:text-gray-300">
                  {{ inviteLink }}
                </code>
        ...
        <div class="card p-6">
          ...
          <div
            ...
            class="mt-4 rounded-lg border border-dashed border-gray-300 p-6 text-center text-sm text-gray-500 dark:border-dark-700 dark:text-dark-400"
          >
...
const inviteLink = computed(() => {
  ...
  const code = encodeURIComponent(detail.value.aff_code)
