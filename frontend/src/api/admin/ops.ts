...
export interface OpenAICodexCompatibilityMetricsSnapshot {
  ...
  recovery_failover_exhaust_applied_total: number
  recovery_failover_exhaust_skipped_total: number
  ...
  recovery_previous_response_skipped_total: number
  recovery_invalid_encrypted_applied_total: number
