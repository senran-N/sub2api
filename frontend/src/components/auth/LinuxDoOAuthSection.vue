<template>
  <div class="space-y-4">
    <button type="button" :disabled="disabled" class="btn btn-secondary w-full" @click="startLogin">
      <svg
        class="linuxdo-oauth-section__icon mr-2"
        viewBox="0 0 16 16"
        version="1.1"
      ...
      >
        <g id="linuxdo_icon" data-name="linuxdo_icon">
          <path
            class="linuxdo-oauth-section__icon-shell"
          ...
          ></path>
          <path
            class="linuxdo-oauth-section__icon-band linuxdo-oauth-section__icon-band--gold"
            d="m1.27,11.33h13.45c-.94,1.89-2.51,3.21-4.51,3.88-1.99.59-3.96.37-5.8-.57-1.25-.7-2.67-1.9-3.14-3.3Z"
          ></path>
          <path
            class="linuxdo-oauth-section__icon-band linuxdo-oauth-section__icon-band--ink"
...
<style scoped>
.linuxdo-oauth-section__icon {
  width: 20px;
  height: 20px;
  color: rgb(var(--theme-brand-orange-rgb));
}

.linuxdo-oauth-section__icon-shell {
  fill: color-mix(in srgb, var(--theme-surface) 92%, white);
}

.linuxdo-oauth-section__icon-band--gold {
  fill: color-mix(in srgb, rgb(var(--theme-warning-rgb)) 88%, rgb(var(--theme-brand-orange-rgb)));
}

.linuxdo-oauth-section__icon-band--ink {
  fill: color-mix(in srgb, var(--theme-page-text) 92%, black);
}
