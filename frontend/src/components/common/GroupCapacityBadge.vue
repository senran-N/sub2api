<template>
  <div class="flex flex-col gap-1">
    ...
    <div class="flex items-center gap-1">
      <span
        :class="[
          'theme-chip theme-chip--compact group-capacity-badge__chip',
      ...
      >
        ...
        <span class="group-capacity-badge__divider">/</span>
...
<style scoped>
.group-capacity-badge__chip {
  font-weight: 600;
}

.group-capacity-badge__divider {
