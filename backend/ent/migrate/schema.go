...
var (
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "provider_key", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
	...
	PendingAuthSessionsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{PendingAuthSessionsColumns[18]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{PendingAuthSessionsColumns[16]},
			},
			{
