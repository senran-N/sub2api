...
func TestOpenAISelectionErrorResponseAfterDefaultFallback_PreservesModelUnavailable(t *testing.T) {
	status, code, message := openAISelectionErrorResponseAfterDefaultFallback(
		fmt.Errorf("%w: %s", service.ErrOpenAIRequestedModelUnavailable, "gpt-does-not-exist"),
		fmt.Errorf("no available accounts"),
	)
...
func TestOpenAISelectionErrorResponseAfterDefaultFallback_UsesFallbackErrorWhenInitialIsGeneric(t *testing.T) {
	status, code, message := openAISelectionErrorResponseAfterDefaultFallback(
		fmt.Errorf("scheduler timeout"),
		fmt.Errorf("no available accounts"),
	)
