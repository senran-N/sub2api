...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	cfg.WeChat.OpenAppSecret = strings.TrimSpace(cfg.WeChat.OpenAppSecret)
	cfg.WeChat.MPAppID = strings.TrimSpace(cfg.WeChat.MPAppID)
	cfg.WeChat.MPAppSecret = strings.TrimSpace(cfg.WeChat.MPAppSecret)
	cfg.WeChat.MobileAppID = strings.TrimSpace(cfg.WeChat.MobileAppID)
	cfg.WeChat.MobileAppSecret = strings.TrimSpace(cfg.WeChat.MobileAppSecret)
	cfg.WeChat.Mode = strings.ToLower(strings.TrimSpace(cfg.WeChat.Mode))
...
func setDefaults() {
	...
	viper.SetDefault("wechat_connect.open_enabled", true)
	...
	viper.SetDefault("gateway.scheduling.priority_mode", GatewaySchedulingPriorityModeStrict)
	...
	viper.SetDefault("token_refresh.request_path_timeout_seconds", 3)
	viper.SetDefault("token_refresh.lock_wait_timeout_milliseconds", 250)
	viper.SetDefault("token_refresh.transient_temp_unsched_minutes", 10)
