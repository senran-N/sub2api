...
import (
	...
	"github.com/senran-N/sub2api/internal/pkg/websearch"
...
func doWebSearch(ctx context.Context, account *Account, query string) (*websearch.SearchResponse, string, error) {
	proxyURL := resolveWebSearchAccountProxyURL(account)
...
func resolveWebSearchAccountProxyURL(account *Account) string {
