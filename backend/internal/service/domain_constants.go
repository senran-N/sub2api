...
// WeChatConnectSyntheticEmailDomain 是 WeChat 用户的合成邮箱后缀（RFC 保留域名）。
...
const (
	...
	SettingKeyBalanceLowNotifyEnabled     = "balance_low_notify_enabled"      // 余额不足提醒总开关
	SettingKeyBalanceLowNotifyThreshold   = "balance_low_notify_threshold"    // 默认余额提醒阈值
	SettingKeyBalanceLowNotifyRechargeURL = "balance_low_notify_recharge_url" // 充值页面 URL
	SettingKeyAccountQuotaNotifyEnabled   = "account_quota_notify_enabled"    // 账号配额提醒总开关
	SettingKeyAccountQuotaNotifyEmails    = "account_quota_notify_emails"     // 管理员提醒邮箱列表
	...
	SettingKeyFrontendTheme               = "frontend_theme"                // 前端主题 ID（如 factory / claude）
	...
	SettingKeyGrokQuotaSyncIntervalSeconds       = "grok_quota_sync_interval_seconds"
	SettingKeyGrokUsageSyncConcurrency           = "grok_usage_sync_concurrency"
	SettingKeyGrokCapabilityProbeIntervalSeconds = "grok_capability_probe_interval_seconds"
	SettingKeyGrokCapabilityProbeConcurrency     = "grok_capability_probe_concurrency"
