...
func TestDeriveOpenAIContentSessionSeed_ChatCompletions_DifferentFirstUserDiffers(t *testing.T) {
	...
	require.NotEqual(t, deriveOpenAIContentSessionSeed(req1), deriveOpenAIContentSessionSeed(req2))
}
...
func TestDeriveOpenAIContentSessionSeed_ChatCompletions_WithTools(t *testing.T) {
	...
	seed := deriveOpenAIContentSessionSeed(withTools)
	require.NotEqual(t, seed, deriveOpenAIContentSessionSeed(withoutTools))
...
func TestDeriveOpenAIContentSessionSeed_ChatCompletions_WithFunctions(t *testing.T) {
	...
	require.Contains(t, deriveOpenAIContentSessionSeed(body), "|functions=")
}
...
func TestDeriveOpenAIContentSessionSeed_ChatCompletions_StructuredContent(t *testing.T) {
	...
	require.Contains(t, deriveOpenAIContentSessionSeed(body), "|first_user=")
}
...
func TestDeriveOpenAIContentSessionSeed_ResponsesAPI_InputString(t *testing.T) {
	...
	require.Contains(t, deriveOpenAIContentSessionSeed(body), "|input=Hello, how are you?")
}
...
func TestDeriveOpenAIContentSessionSeed_Deterministic(t *testing.T) {
	...
	require.Equal(t, deriveOpenAIContentSessionSeed(body), deriveOpenAIContentSessionSeed(body))
}
...
func TestDeriveOpenAIContentSessionSeed_EmptyToolsIgnored(t *testing.T) {
	...
	require.NotContains(t, deriveOpenAIContentSessionSeed(body), "|tools=")
}
